...
// floored to MIN_BAR_SHARE so a tiny bar never vanishes; a zero share stays empty. WHIT-373: the
// card is a pure summary — the Insights page drills into Earned/Spent via its own Spending/Earning
// toggle, so this bar carries no navigation.
