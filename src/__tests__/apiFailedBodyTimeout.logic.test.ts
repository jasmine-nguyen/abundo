...
// WHIT-441 item 3 (gaps) — two claims the doc-comment makes that the suite above doesn't check:
// (1) a body that REJECTS fast settles immediately, not after the timeout; (2) the timeout timer is
// CLEARED on both arms (.finally) — no real-timer leak / lingering handle.
