...
// WHIT-501: leave the server tally undefined so the dot falls back to the LOCAL recent-window
// count — this test's fail-on-revert restores the countUncategorized gate, which must still drive the dot.
